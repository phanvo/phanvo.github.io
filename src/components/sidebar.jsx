        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              <h1 id="colorlib-logo"><a href="index.html">Phan Vo</a></h1>
              <span className="email"><i className="icon-mail"></i>phanvo@gmail.com</span>
            </div>
            ...
            <nav id="colorlib-main-menu">
              <ul>
                ...
                <li><a href="https://www.linkedin.com/in/phan-vo-15403529/" target="_blank" rel="noopener noreferrer"><i className="icon-linkedin2" /></a></li>
                <li><a href="https://github.com/phanvo" target="_blank" rel="noopener noreferrer"><i className="icon-github"></i></a></li>
